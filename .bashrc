...
alias f='find'
alias g='grep'
alias ga='kubectl get pods --sort-by=.metadata.creationTimestamp |tail |tac'
alias gaa='kubectl get pods -A --sort-by=.metadata.creationTimestamp |tail |tac'
alias gc='grep --color'
...
alias ,ew='kubectl get pod -owide |grep -E "NAME|CrashLoopBackOff|Error|ImagePullBackOff|ErrImagePull|Evicted|Failed|ContainerCreating|ContainerStatusUnknown|Pending|Terminating"'
...
alias ,eaw='kubectl get pod -A -owide |grep -E "NAMESPACE|CrashLoopBackOff|Error|ImagePullBackOff|ErrImagePull|Evicted|Failed|ContainerCreating|ContainerStatusUnknown|Pending|Terminating"'
